...
export default function ProjectCard({ title, description, techStack, imageSrc }: ProjectCardProps) {
  return (
    <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 text-white text-shadow-lg flex flex-col h-full relative transition-transform duration-300 hover:scale-105 hover:shadow-lg">
