...
export default function Home() {
  return (
    <main className="flex min-h-screen items-center justify-center p-24 bg-cover bg-center" style={{ backgroundImage: 'url(/path/to/your/background-image.jpg)' }}>
      <div className="flex w-full max-w-7xl lg:flex-row flex-col items-center justify-center">
        ...
        <div className="flex-1 mb-32 lg:mb-0 lg:w-2/3 lg:text-left text-center flex flex-col justify-center">
          <div>
            <TypeAnimation
              ...
              cursor={false}
              repeat={0}
              className="mb-3 text-3xl font-semibold text-white text-shadow"
            />
            <TypeAnimation
              sequence={[
                1200, 
          ...
          <p className="max-w-[80ch] text-lg leading-relaxed text-white text-shadow">
        ...
        <div className="flex-1 mb-32 lg:mb-0 lg:w-1/3 lg:text-left text-center flex flex-col space-y-4 justify-center">
          <a
            ...
            className="group rounded-lg border border-transparent px-4 py-3 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 flex items-center justify-center w-2/3 mx-auto"
            target="_blank"
